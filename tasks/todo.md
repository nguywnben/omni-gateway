...
- [x] W4.16 Coordinate identity/session/security runtime state.
  ...
  - [x] W4.16.4 Implement Redis throttle and OIDC transaction parity.
  - [x] W4.16.5 Move management sessions behind the typed boundary.
...
- [ ] W4.17 Coordinate routing/governance/cache runtime state.
  ...
  - [ ] W4.17.2 Add readable fenced-record parity.
  - [ ] W4.17.3 Implement the semantic routing/cache coordination adapter.
