...
- [ ] W4.16 Coordinate identity/session/security runtime state.
  - [ ] W4.16.1 Define the strict security coordination domain and shared contract.
  ...
  - [ ] W4.16.6 Coordinate login, recovery, and OIDC-start attempts.
  - [ ] W4.16.7 Coordinate one-time OIDC transaction proofs.
  - [ ] W4.16.8 Add live parity and operability evidence.
