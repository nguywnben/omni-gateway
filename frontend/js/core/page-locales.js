...
const PRODUCTION_DASHBOARD_MESSAGES = {
    en: {
        ...
        'dashboard.readiness_checking': 'Checking readiness',
        'dashboard.readiness_checking_title': 'Checking your gateway',
        'dashboard.readiness_checking_description': 'Loading credentials, traffic, and request health.',
        'dashboard.quick_actions': 'Quick actions',
        'dashboard.action_add_provider': 'Add provider',
        'dashboard.action_credentials': 'Credentials',
        'dashboard.action_routes': 'Model routes',
        'dashboard.action_activity': 'View activity',
        'dashboard.action_review_credentials': 'Review credentials',
        'dashboard.action_investigate': 'Investigate activity',
        ...
        'dashboard.advanced_monitoring': 'Advanced monitoring integrations',
        ...
        'dashboard.state_first_time': 'Setup required',
        'dashboard.state_first_time_title': 'Connect your first provider',
        'dashboard.state_first_time_description': 'Add an account, API key, or local model server before sending requests.',
        'dashboard.state_no_provider': 'No active provider',
        'dashboard.state_no_provider_title': 'Restore routing capacity',
        'dashboard.state_no_provider_description': 'Existing credentials are disabled or unavailable. Review them or add a provider.',
        'dashboard.state_healthy': 'Healthy',
        'dashboard.state_healthy_title': 'Gateway traffic is healthy',
        'dashboard.state_healthy_description': 'Active providers are serving requests without a current health warning.',
        'dashboard.state_ready_title': 'Gateway is ready for traffic',
        'dashboard.state_ready_description': 'Active credentials are available. Send a request when you are ready.',
        'dashboard.state_degraded': 'Needs attention',
        'dashboard.state_degraded_title': 'Some requests need attention',
        'dashboard.state_degraded_description': 'Open Activity to identify failing routes, cooldowns, or capacity pressure.',
    ...
    vi: {
        ...
        'dashboard.readiness_checking': 'Đang kiểm tra mức sẵn sàng',
        'dashboard.readiness_checking_title': 'Đang kiểm tra gateway',
        'dashboard.readiness_checking_description': 'Đang tải thông tin xác thực, lưu lượng và tình trạng yêu cầu.',
        'dashboard.quick_actions': 'Thao tác nhanh',
        'dashboard.action_add_provider': 'Thêm nhà cung cấp',
        'dashboard.action_credentials': 'Thông tin xác thực',
        'dashboard.action_routes': 'Tuyến mô hình',
        'dashboard.action_activity': 'Xem hoạt động',
        'dashboard.action_review_credentials': 'Kiểm tra thông tin xác thực',
        'dashboard.action_investigate': 'Điều tra hoạt động',
        ...
        'dashboard.advanced_monitoring': 'Tích hợp giám sát nâng cao',
        ...
        'dashboard.state_first_time': 'Cần thiết lập',
        'dashboard.state_first_time_title': 'Kết nối nhà cung cấp đầu tiên',
        'dashboard.state_first_time_description': 'Thêm tài khoản, khóa API hoặc máy chủ mô hình cục bộ trước khi gửi yêu cầu.',
        'dashboard.state_no_provider': 'Không có nhà cung cấp hoạt động',
        'dashboard.state_no_provider_title': 'Khôi phục năng lực định tuyến',
        'dashboard.state_no_provider_description': 'Thông tin xác thực hiện có đang bị tắt hoặc không khả dụng. Hãy kiểm tra hoặc thêm nhà cung cấp.',
        'dashboard.state_healthy': 'Ổn định',
        'dashboard.state_healthy_title': 'Lưu lượng gateway đang ổn định',
        'dashboard.state_healthy_description': 'Các nhà cung cấp hoạt động đang xử lý yêu cầu mà không có cảnh báo hiện tại.',
        'dashboard.state_ready_title': 'Gateway đã sẵn sàng nhận lưu lượng',
        'dashboard.state_ready_description': 'Đã có thông tin xác thực hoạt động. Bạn có thể gửi yêu cầu khi sẵn sàng.',
        'dashboard.state_degraded': 'Cần xử lý',
        'dashboard.state_degraded_title': 'Một số yêu cầu cần được kiểm tra',
        'dashboard.state_degraded_description': 'Mở Hoạt động để xác định tuyến lỗi, thời gian tạm nghỉ hoặc áp lực dung lượng.',
