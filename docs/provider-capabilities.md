...
| Provider variant | Authentication | Add | Verify | Test | Refresh | Quota | Models | Protocols | Disable | Export | Delete |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Google Antigravity | OAuth | Yes | Yes | Yes | Yes | Yes | Yes | All | Yes | Yes | Yes |
| Google AI Studio | API key | Yes | Yes | Yes | No | No | Yes | All | Yes | Yes | Yes |
| Grok Build | OAuth | Yes | Yes | Yes | Yes | Yes | Yes | All | Yes | Yes | Yes |
| SpaceXAI Console | API key | Yes | Yes | Yes | No | No | Yes | All | Yes | Yes | Yes |
| Codex | OAuth | Yes | Yes | Yes | Yes | Yes | Yes | All | Yes | Yes | Yes |
| OpenAI Platform | API key | Yes | Yes | Yes | No | No | Yes | All | Yes | Yes | Yes |
| Claude Code | OAuth | Yes | Yes | Yes | Yes | No | Yes | All | Yes | Yes | Yes |
| Claude Platform | API key | Yes | Yes | Yes | No | No | Yes | All | Yes | Yes | Yes |
| Ollama | Connection | Yes | Yes | Yes | No | No | Yes | All | Yes | Yes | Yes |
...
- `verify` validates the credential and refreshes its available model metadata.
