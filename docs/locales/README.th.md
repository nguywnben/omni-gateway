...
เมื่อรันครั้งแรก หน้าตั้งค่าจะตรวจสอบที่จัดเก็บ ที่อยู่คอนโซล การเชื่อมต่อ/คุกกี้ และสถานะการติดตั้งก่อนเปิดให้สร้างเจ้าของ ไม่มีรหัสผ่านเริ่มต้น การตั้งค่าโดยตรงผ่าน localhost ไม่ต้องใช้โทเค็น ก่อนตั้งค่าจากระยะไกล ให้กำหนด `SETUP_TOKEN` ที่ไม่ซ้ำกันอย่างน้อย 24 ตัวอักษรแล้วเริ่มบริการใหม่ แอปจะไม่สร้างหรือบันทึกความลับนี้ รหัสผ่านเจ้าของต้องยาว 12–256 ตัวอักษร
...
| `SETUP_TOKEN` | ว่าง | ต้องกำหนดก่อนตั้งค่าจากระยะไกลครั้งแรก ใช้ค่าที่ไม่ซ้ำกันอย่างน้อย 24 ตัวอักษร แอปจะไม่สร้างหรือบันทึกค่านี้ และไม่จำเป็นสำหรับ localhost โดยตรง |
