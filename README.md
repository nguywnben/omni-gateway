...
Omni Gateway
  authentication -> format translation -> token-aware cleanup -> routing -> fallback -> streaming
        ...
        v
provider adapters
  Google Antigravity | Google AI Studio | Grok Build | SpaceXAI Console | Code Assist | Vertex-compatible route
```
